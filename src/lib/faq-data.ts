...
export const faqItems: FaqItem[] = [
  ...
  { category: 'GENERAL', question: 'When was the Rich City League founded?', answer: "Rich City League was founded in Richmond in 2011, beginning the league's mission to create meaningful competition, community and a platform for Richmond basketball.", keywords: ['history', '2011', 'founded'] },
