...
export default function SocialPage() {
  ...
  return <main className="rcl-social-page relative min-h-screen bg-[#05080d] text-white pb-20 lg:pb-0"><ContentAssetBackground assetKey="social.cover" opacity={0.08} /><div className="relative z-10">
