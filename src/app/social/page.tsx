...
export default function SocialPage() {
  ...
  const [storyIndex, setStoryIndex] = useState<number | null>(null); const [composerOpen, setComposerOpen] = useState(false);
