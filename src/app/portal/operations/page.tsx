...
export default function OperationsPage() {
  ...
  return <main><Container maxWidth="xl" className="py-12"><p className="text-xs font-bold uppercase tracking-[0.2em] text-rcl-gold">{profile.role} portal</p><h1 className="mt-2 font-display text-4xl font-bold">League operations</h1><p className="mt-3 text-gray-400">Manage authorized rosters and record official game statistics.</p><div className="mt-5"><a href="/portal/scorebook" className="inline-flex rounded-xl bg-rcl-orange px-4 py-3 text-[10px] font-black uppercase tracking-widest text-black">Open RCL Game IQ Scorebook</a></div>{message && <p className="mt-4 rounded-lg bg-emerald-400/10 p-3 text-sm text-emerald-300">{message}</p>}{error && <p className="mt-4 rounded-lg bg-red-400/10 p-3 text-sm text-red-300">{error}</p>}
