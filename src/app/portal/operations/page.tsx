...
import type { Game, Player, PlayerGameStats, Registration, Roster, Team, TeamSeason } from '@/types/database';
...
export default function OperationsPage() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      if (!supabase) return;
      try {
        const [registrationResult, gameResult, playerResult, teamResult, teamSeasonResult, rosterResult, statResult, coachResult] = await Promise.all([
        ...
        const resultError = [registrationResult, gameResult, playerResult, teamResult, teamSeasonResult, rosterResult, statResult, coachResult].find((result) => result.error)?.error;
