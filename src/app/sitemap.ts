...
const core=[
  ['',1,'daily'],['/about',.9,'monthly'],['/news',.9,'daily'],['/players',.9,'daily'],['/teams',.9,'daily'],['/games',.9,'daily'],['/standings',.85,'daily'],['/leaderboards',.85,'daily'],['/schedule',.85,'daily'],['/stats',.8,'daily'],['/runs',.8,'daily'],['/communities',.75,'daily'],['/fantasy',.75,'weekly'],['/draft',.7,'weekly'],['/media',.7,'weekly'],['/faq',.7,'monthly'],['/join',.9,'weekly']
] as const;
