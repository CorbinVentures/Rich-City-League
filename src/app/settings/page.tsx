...
const items=[['Account','Profile, identity and participation settings','/profile'],['Security','Password and account security','/account/security'],['Notifications','Manage your RCL notifications','/notifications'],['Messages','Open your RCL conversations','/messages'],['Privacy','Privacy controls and data requests','/settings/privacy'],['Legal & Safety','Terms, privacy, copyright and community rules','/legal']];
