...
export const metadata: Metadata = { title:{ absolute:'About RCL | Richmond Basketball Since 2011' }, description:'Learn the history and mission of Rich City League, a Richmond-born basketball organization founded in 2011 and rebuilt as a year-round basketball ecosystem.', alternates:{canonical:'/about'} };
